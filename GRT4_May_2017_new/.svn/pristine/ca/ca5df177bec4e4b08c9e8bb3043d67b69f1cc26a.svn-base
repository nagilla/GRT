...
public class ResponseType {
    ...
    @XmlElement(name = "TechRegResponseList", required = true)
    protected List<TechRegResponseListType> techRegResponseList;
     ...
     * 
     */
    public List<TechRegResponseListType> getTechRegResponseList() {
        if (techRegResponseList == null) {
            techRegResponseList = new ArrayList<TechRegResponseListType>();
        }
        return this.techRegResponseList;
    }
