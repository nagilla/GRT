...
public class CXPSoldToImpl extends BaseHibernateDao implements CXPSoldToDao{
	
	private static final Logger logger = Logger.getLogger(CXPSoldToImpl.class);
    ...
    public Account getAccountInfo(String soldToId) throws DataAccessException {
		...
		try {
			//String schema = GRTPropertiesUtil.getProperty(GRTConstants.CXP_USER_NAME).trim();
			String schema = "CXP2";
